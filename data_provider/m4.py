...
if __name__ == '__main__':
    ...
    # 下载数据集示例
    dataset_url = 'https://example.com/path/to/m4-dataset.zip'
    dataset_path = '../dataset/m4-dataset.zip'
    download(dataset_url, dataset_path)

    # 加载数据集示例
    m4_dataset = M4Dataset.load(training=True)  # 加载训练集
    print(m4_dataset.ids)  # 打印所有时间序列的 ID
